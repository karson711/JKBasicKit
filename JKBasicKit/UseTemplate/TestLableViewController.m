...
- (void)viewDidLoad {
    ...
    //需要点击的字符不同
    NSString *label_text2 = @"您好！您是小明吗？你中奖了，领取地址“https://github.com/kunge/WYBasisKit”,领奖码“记得给star哦”";
    ...
    //通过block设置要点击的字符串
    [label2 clickRichTextWithStrings:@[@"https://github.com/kunge/WYBasisKit",@"记得给star哦"] clickAction:^(NSString *string, NSRange range, NSInteger index) {
