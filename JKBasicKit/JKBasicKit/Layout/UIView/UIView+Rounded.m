...
@implementation CALayer (Rounded)
...
- (void)cornerRadius:(CGFloat)radius cornerColor:(UIColor *)color corners:(UIRectCorner)corners {
    ...
    [self cornerRadii:CGSizeMake(radius, radius) cornerColor:color corners:corners borderColor:nil borderWidth:0];
}
...
- (void)cornerRadii:(CGSize)cornerRadii cornerColor:(UIColor *)color corners:(UIRectCorner)corners borderColor:(UIColor *)borderColor borderWidth:(CGFloat)borderWidth {
    ...
    [self.layer cornerRadii:cornerRadii cornerColor:color corners:corners borderColor:borderColor borderWidth:borderWidth];
}
